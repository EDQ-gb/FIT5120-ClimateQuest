...
export async function getTasks() {
  try {
    return (await req('/api/tasks')).map(normalizeTask)
  } catch (e) {
    ...
    return TASKS.map(t => normalizeTask({ ...t, completed: done.includes(t.id) }))
  }
}
